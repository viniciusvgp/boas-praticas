...
RUN apt -y install libxml2-dev libssl-dev libcurl4-openssl-dev libgit2-dev libboost-dev git python curl autoconf file libgmp-dev libopenmpi-dev gawk emacs ess && apt clean
